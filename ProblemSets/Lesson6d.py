...
def slam(data, N, num_landmarks, motion_noise, measurement_noise):
    ...
    for k in range(len(data)):
        ...
        for i in range(len(measurement)):
            m = 2 * (N + measurement[i][0]) # landmark index
            
            omega.value[n + 0][n + 0] += 1 / measurement_noise
            omega.value[m + 0][m + 0] += 1 / measurement_noise
            omega.value[n + 0][m + 0] -= 1 / measurement_noise
            omega.value[m + 0][n + 0] -= 1 / measurement_noise
            omega.value[n + 1][n + 1] += 1 / measurement_noise
            omega.value[m + 1][m + 1] += 1 / measurement_noise
            omega.value[n + 1][m + 1] -= 1 / measurement_noise
            omega.value[m + 1][n + 1] -= 1 / measurement_noise
                    
            xi.value[n + 0][0] -= measurement[i][1] / measurement_noise
            xi.value[m + 0][0] += measurement[i][1] / measurement_noise
            xi.value[n + 1][0] -= measurement[i][2] / measurement_noise
            xi.value[m + 1][0] += measurement[i][2] / measurement_noise
            
        omega.value[n + 0][n + 0] += 1 / motion_noise
        omega.value[n + 1][n + 1] += 1 / motion_noise       
        omega.value[n + 2][n + 2] += 1 / motion_noise
        omega.value[n + 3][n + 3] += 1 / motion_noise 
        omega.value[n + 0][n + 2] -= 1 / motion_noise
        omega.value[n + 2][n + 0] -= 1 / motion_noise
        omega.value[n + 1][n + 3] -= 1 / motion_noise
        omega.value[n + 3][n + 1] -= 1 / motion_noise
        
        xi.value[n + 0][0] -= motion[0] / motion_noise
        xi.value[n + 2][0] += motion[0] / motion_noise
        xi.value[n + 1][0] -= motion[1] / motion_noise
        xi.value[n + 3][0] += motion[1] / motion_noise
