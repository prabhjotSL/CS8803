...
def run(param1, param2, param3):
    ...
    i_error = 0
    for i in range(N):
        d_error = myrobot.y - crosstrack_error
        crosstrack_error = myrobot.y
        i_error += crosstrack_error        
        steering = - param1 * crosstrack_error \
                   - param2 * d_error \
                   - param3 * i_error
        newpos = myrobot.move(steering, speed)
        myrobot.set(newpos.x, newpos.y, newpos.orientation)
