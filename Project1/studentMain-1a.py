...
def estimate_next_pos(measurement, OTHER = None):
    ...
    if not OTHER: # first time
        ...
        P = matrix([[1000., 0., 0., 0.], 
                    [0., 1000., 0., 0.],
                    [0., 0., 1000., 0.],
                    [0., 0., 0., 1000.]])   # covariance
    else:
        x = OTHER[0]
        P = OTHER[1]    
    Z = matrix([[measurement[0]],           # measurements
                [measurement[1]]])
    u = matrix([[0.],
                [0.],
                [0.],
                [0.]])                      # external motion (control)
    F = matrix([[1., 0., 1., 0.], 
                [0., 1., 0., 1.],
                [0., 0., 1., 0.],
    ...
    x, P = KalmanFilter(Z, x, P, u, F, H, R, I)
...
def KalmanFilter(Z, x, P, u, F, H, R, I):
        
    # measurement update
    y = Z - H * x                       # error
    S = H * P * H.transpose() + R       # measurement error
